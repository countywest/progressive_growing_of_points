...
class Arguments():
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', default='auto_encoder', help='auto_encoder')
        self.parser.add_argument('--model_id', default='pn_topnet_ae', help='THIS MUST BE EQUAL TO THE MODEL ID IN config.yaml')
